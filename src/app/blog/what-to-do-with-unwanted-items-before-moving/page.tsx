...
export const metadata: Metadata = {
  title: 'ماذا تفعل بأغراضك غير المرغوب فيها قبل نقل العفش؟ (حلول التخلص والتبرع) - مدونة نقل العفش',
  ...
  openGraph: {
    ...
    description: 'استراتيجيات عملية للتخلص من الأغراض غير الضرورية قبل الانتقال بطرق مستدامة وذكية.',
    images: ['/images/blog/unwanted-items-solutions.jpg'],
  },
};
